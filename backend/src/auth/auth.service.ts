...
export class AuthService {
  ...
  async me(userId: string, choirId?: string) {
    ...
    const devotionAuth = choirId
      ? await this.devotionCapabilities.resolveGrantsToCapabilities(
          userId,
          choirId,
        )
      : undefined;
    ...
    const protocolAuth =
      await this.platformCapabilities.resolveProtocolAuth(userId);
    const churchAuth =
      await this.platformCapabilities.resolveChurchAuth(userId);
    const platformAuth =
