...
export type ChoirServiceSlotCode =
  | 'SUNDAY_SERVICE_1'
  | 'SUNDAY_SERVICE_2'
  | 'TUESDAY_SERVICE'
  | 'FRIDAY_SERVICE'
...
const SLOT_LABELS: Record<Exclude<ChoirServiceSlotCode, 'OTHER'>, string> = {
...
@Injectable()
export class ChoirServiceOccurrenceService {
  constructor(private prisma: PrismaService) {}

  slotLabel(code: ChoirServiceSlotCode, customName?: string) {
    if (code === 'OTHER') {
