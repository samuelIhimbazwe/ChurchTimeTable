...
export const LEGACY_PERMISSION_ALIASES: Record<string, readonly string[]> = {
  ...
  'choir.music.view': ['choir.music.view@choir'],
  'choir.music.manage': ['choir.music.manage@choir'],
  'choir.rehearsal.view': ['choir.rehearsal.view@choir', 'choir.ops.view@choir'],
  ...
  'event:read': ['choir.ops.view@choir', 'choir.rehearsal.view@choir'],
