...
export function MembershipAttendancePanel() {
    ...
    <div className="space-y-5">
      <div className="grid grid-cols-2 gap-4 max-w-lg">
        {loadingAttendance ? (
          ...
          <>
            <StatTile label="Attendance rate" value={rate} suffix="%" icon={CheckCircle2} animate />
            <StatTile label="Events recorded" value={records.length} icon={Calendar} animate />
          </>
        )}
      </div>
