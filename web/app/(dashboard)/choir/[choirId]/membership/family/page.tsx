...
export default function MembershipFamilyPage() {
  ...
  return (
    <div className="space-y-5">
      <div>
        <h2 className="font-display text-xl text-text-primary">My family team</h2>
        <p className="text-sm text-text-muted mt-0.5">
          Your team and the account you pay into for choir giving.
        </p>
      </div>
      ...
      <Link
        href={`${membershipOfficePath(choirId, 'giving')}?tab=submit`}
